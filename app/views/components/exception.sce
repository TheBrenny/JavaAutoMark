<div class="test" data-order="[[order]]" data-testid="[[testID]]" data-exception>
    ...
    <div class="excCenter">
        ...
        <div class="testDeets">
            <input class="out small" type="text" name="expectedOutput" placeholder="Exception" value="[[expected]]" />
            <input class="num small mark" type="number" name="marks" placeholder="Marks" value="[[marks]]" />
            <input class="desc" type="text" name="description" placeholder="Exception Description" value="[[description]]" />
        </div>
    </div>
